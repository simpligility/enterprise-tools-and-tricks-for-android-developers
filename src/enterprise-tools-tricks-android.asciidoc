...
----
provided group: 'org.gradle.test.classifiers', name: 'service', version: '1.0', classifier: 'jdk14'
----
...
* allows you to publish Android SDK components to repository manager

* https://github.com/mosabua/maven-android-sdk-deployer

* necessary since Google does not provide components in any repository
